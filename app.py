...
training_data = [
    ...
    ("cinema admission", "Entertainment", "Movies/Shows"),
    # Additional Entertainment entries
    ("Netflix monthly subscription", "Entertainment", "Movies/Shows"),
    ("Disney+ annual plan", "Entertainment", "Movies/Shows"),
    ("HBO Go subscription", "Entertainment", "Movies/Shows"),
    ("Amazon Prime Video", "Entertainment", "Movies/Shows"),
    ("Viu Premium account", "Entertainment", "Movies/Shows"),
    ("movie date night", "Entertainment", "Movies/Shows"),
    ("sine sa mall", "Entertainment", "Movies/Shows"),
    ("manood ng pelikula", "Entertainment", "Movies/Shows"),
    ("block screening ticket", "Entertainment", "Movies/Shows"),
    ("3D movie showing", "Entertainment", "Movies/Shows"),
    ("IMAX cinema ticket", "Entertainment", "Movies/Shows"),
    ("premiere night ticket", "Entertainment", "Movies/Shows"),
    ("advance screening pass", "Entertainment", "Movies/Shows"),
    ("movie marathon ticket", "Entertainment", "Movies/Shows"),
    ("film festival pass", "Entertainment", "Movies/Shows"),

    ("Bini concert", "Entertainment", "Concert Tickets/Events"),
    ("SB19 fan meet", "Entertainment", "Concert Tickets/Events"),
    ("Ben&Ben live show", "Entertainment", "Concert Tickets/Events"),
    ("music festival ticket", "Entertainment", "Concert Tickets/Events"),
    ("concert VIP ticket", "Entertainment", "Concert Tickets/Events"),
    ("meet and greet pass", "Entertainment", "Concert Tickets/Events"),
    ("fan meeting ticket", "Entertainment", "Concert Tickets/Events"),
    ("concert merchandise", "Entertainment", "Concert Tickets/Events"),
    ("backstage pass", "Entertainment", "Concert Tickets/Events"),
    ("concert tour ticket", "Entertainment", "Concert Tickets/Events"),

    ("Mobile Legends diamonds", "Entertainment", "Gaming"),
    ("Valorant points", "Entertainment", "Gaming"),
    ("Roblox premium", "Entertainment", "Gaming"),
    ("gaming console", "Entertainment", "Gaming"),
    ("gaming accessories", "Entertainment", "Gaming"),
    ("game credits", "Entertainment", "Gaming"),
    ("in-app purchase", "Entertainment", "Gaming"),
    ("game subscription", "Entertainment", "Gaming"),
    ("gaming tournament fee", "Entertainment", "Gaming"),
    ("gaming PC parts", "Entertainment", "Gaming"),

    ("painting materials", "Entertainment", "Hobbies"),
    ("musical instrument", "Entertainment", "Hobbies"),
    ("photography equipment", "Entertainment", "Hobbies"),
    ("craft workshop fee", "Entertainment", "Hobbies"),
    ("hobby class", "Entertainment", "Hobbies"),
    ("art workshop", "Entertainment", "Hobbies"),
    ("hobby supplies", "Entertainment", "Hobbies"),
    ("craft materials", "Entertainment", "Hobbies"),
    ("hobby equipment rental", "Entertainment", "Hobbies"),
    ("hobby club membership", "Entertainment", "Hobbies"),

    # Additional Savings & Investments entries
    ("stock market investment", "Savings & Investments", "Investments"),
    ("mutual fund placement", "Savings & Investments", "Investments"),
    ("digital wallet savings", "Savings & Investments", "Savings Goals"),
    ("time deposit", "Savings & Investments", "Investments"),
    ("government bonds", "Savings & Investments", "Investments"),
    ("cryptocurrency purchase", "Savings & Investments", "Investments"),
    ("index fund investment", "Savings & Investments", "Investments"),
    ("dividend stocks", "Savings & Investments", "Investments"),
    ("emergency fund deposit", "Savings & Investments", "Emergency Fund"),
    ("retirement fund contribution", "Savings & Investments", "Retirement"),
    ("ipon para sa future", "Savings & Investments", "Savings Goals"),
    ("investment sa stocks", "Savings & Investments", "Investments"),
    ("savings account deposit", "Savings & Investments", "Savings Goals"),
    ("long term investment", "Savings & Investments", "Investments"),
    ("short term investment", "Savings & Investments", "Investments"),

    # Additional Insurance entries
    ("life insurance premium", "Insurance", "Life Insurance"),
    ("health card renewal", "Insurance", "Health Insurance"),
    ("accident insurance", "Insurance", "Life Insurance"),
    ("property insurance", "Insurance", "Home Insurance"),
    ("business insurance", "Insurance", "Life Insurance"),
    ("travel insurance policy", "Insurance", "Travel Insurance"),
    ("insurance installment", "Insurance", "Life Insurance"),
    ("HMO family coverage", "Insurance", "Health Insurance"),
    ("insurance renewal fee", "Insurance", "Life Insurance"),
    ("insurance policy upgrade", "Insurance", "Life Insurance"),
    ("seguro sa buhay", "Insurance", "Life Insurance"),
    ("health card payment", "Insurance", "Health Insurance"),
    ("insurance protection", "Insurance", "Life Insurance"),
    ("insurance coverage fee", "Insurance", "Life Insurance"),
    ("insurance plan payment", "Insurance", "Life Insurance"),
]
